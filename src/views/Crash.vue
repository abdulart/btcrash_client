      ...
      <div class="row">
            ...
            <div class="crash-navigation">
              <div class="form-row">
                <div class="form-group col-md-4 m0">
                  <input class="form-control input-stake" type="number" placeholder="Ваша ставка" v-model="stake" min="0">
                </div>
                <div class="form-group col-md-8 m0">
                  <div class="buttons-right">
                    <div v-if="!gameInProcess && !inGame">
                      <button v-if="!afterGame" @click="makeStake" type="button" class="btn btn-success" >Ставка</button>
                    </div>
                    <div v-else-if="!gameInProcess && inGame">
                    </div>
                    <div v-else-if="gameInProcess && inGame">
                      <button v-if="inGame" @click="stopGame" type="button" class="btn btn-danger" >Выход</button>
                    </div>
                    <div v-else>
                      <span>Идет игра</span>
                    </div>
        ...
        <div class="col-sm-4 crash-block">
          <div class="element-container">
            ...
            <div class="o-y-s">
              <ul>
                <li v-for="player in in_game" class="last-game-entity">
        ...
        <div class="col-sm-2 crash-block">
          <div class="element-container">
            ...
            <div class="o-y-s">
              <ul>
                <li v-for="game in last_games" class="last-game-entity">
...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      this.socket.on('succeedStake', (obj) => {
